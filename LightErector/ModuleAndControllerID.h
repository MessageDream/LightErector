...
enum ModuleAndControllerID
{
    ...
    VIEWCONTROLLER_ORDERCATEGORYLIST,
    VIEWCONTROLLER_UNSETTLED,
    VIEWCONTROLLER_USERCENTER,
    VIEWCONTROLLER_SUBCLIENT,
    
    VIEWCONTROLLER_CHAGEUSERINFO,
    VIEWCONTROLLER_SYSTEMNOTICE,
